...
@Component({
  ...
  template: `
    <header class="topnav-header h-12 flex items-center justify-between px-3 sm:px-4 bg-white dark:bg-dark-base relative z-30 transition-colors duration-500">
          ...
          @if (userDropdownOpen()) {
            <div class="absolute right-0 top-full mt-2 w-56 card-premium overflow-hidden z-50 animate-fade-in shadow-md dark:shadow-xl" id="topnav-user-dropdown">
              @if (auth.isLoggedIn()) {
                ...
                <div class="py-1.5">
                  <a routerLink="/user/settings" (click)="userDropdownOpen.set(false)" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-primary/5 dark:hover:bg-white/[0.04] hover:text-slate-900 dark:hover:text-white transition-colors">
                  ...
                  <button (click)="toggleTheme()" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-primary/5 dark:hover:bg-white/[0.04] hover:text-slate-900 dark:hover:text-white transition-colors w-full text-left">
                  ...
                  <a href="#" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-primary/5 dark:hover:bg-white/[0.04] hover:text-slate-900 dark:hover:text-white transition-colors">
                ...
                <div class="py-1.5">
                  <a routerLink="/user/login" (click)="userDropdownOpen.set(false)" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-primary/5 dark:hover:bg-white/[0.04] hover:text-slate-900 dark:hover:text-white transition-colors">
                  ...
                  <a routerLink="/user/register" (click)="userDropdownOpen.set(false)" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-primary/5 dark:hover:bg-white/[0.04] hover:text-slate-900 dark:hover:text-white transition-colors">
    ...
    @if (userDropdownOpen()) {
      <div (click)="userDropdownOpen.set(false)" class="fixed inset-0 z-20"></div>
    }
