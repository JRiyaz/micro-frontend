...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-slate-50 dark:bg-[#0a0b1e] overflow-hidden relative">

      <!-- Nav -->
      <nav class="relative z-20 border-b border-slate-200 dark:border-white/[0.06] bg-white/80 dark:bg-[#0a0b1e]/80 backdrop-blur-xl sticky top-0">
        <div class="flex justify-between items-center px-6 lg:px-8 py-4 max-w-7xl mx-auto">
          <div class="flex items-center gap-2.5">
            ...
            <span class="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Inven<span class="text-[#6d74ff]">tory</span></span>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <button (click)="mobileMenu.set(!mobileMenu())" class="md:hidden ml-1 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white p-1">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
            </button>
          </div>
        </div>
        <div *ngIf="mobileMenu()" class="md:hidden border-t border-slate-200 dark:border-white/[0.06] px-6 py-3 space-y-2 bg-white/95 dark:bg-[#0a0b1e]/95 backdrop-blur-xl">
      ...
      <main class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-16 sm:pt-24 pb-20 sm:pb-32 flex flex-col items-center text-center">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] backdrop-blur-md rounded-full mb-8 text-xs font-bold text-[#6d74ff] uppercase tracking-widest shadow-sm dark:shadow-none">
          <span class="w-2 h-2 bg-green-400 rounded-full"></span>
          Now in Beta — Free for Teams
        </div>
        <h1 class="text-4xl sm:text-6xl lg:text-8xl font-black tracking-tighter mb-6 leading-[1.05] text-slate-900 dark:text-white">
        ...
        <p class="text-base sm:text-xl text-slate-600 dark:text-slate-300 max-w-2xl mb-12 leading-relaxed">
        ...
        <!-- Preview -->
        <div class="w-full max-w-5xl bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] backdrop-blur-md rounded-2xl sm:rounded-3xl p-2 sm:p-4 shadow-xl dark:shadow-2xl relative">
          <div class="absolute inset-0 bg-gradient-to-t from-white/90 dark:from-[#0a0b1e]/90 via-transparent to-transparent z-10 rounded-2xl pointer-events-none"></div>
          <div class="bg-slate-50 dark:bg-[#111336] rounded-xl overflow-hidden border border-slate-200 dark:border-transparent">
            <div class="flex items-center gap-2 px-4 py-3 border-b border-slate-200 dark:border-white/[0.06]">
              ...
              <div class="flex-1 flex justify-center"><div class="px-4 py-1 bg-white dark:bg-[#0a0b1e]/50 border border-slate-200 dark:border-transparent rounded-md text-[10px] text-slate-500 font-mono shadow-sm dark:shadow-none">inventory.app/dashboard</div></div>
            </div>
            <div class="p-4 sm:p-8 min-h-[200px] sm:min-h-[350px]">
              <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                <div *ngFor="let s of previewStats" class="bg-white dark:bg-[#1e2048] shadow-sm dark:shadow-none border border-slate-200 dark:border-transparent rounded-xl p-3 sm:p-4" [class]="'border-l-4 ' + s.border">
              ...
              <div class="space-y-2">
                <div *ngFor="let i of [1,2,3]" class="flex items-center gap-3 bg-white dark:bg-[#1e2048]/60 border border-slate-200 dark:border-transparent shadow-sm dark:shadow-none rounded-lg p-3">
                  <div class="w-8 h-8 rounded-lg bg-[#6d74ff]/10 dark:bg-[#6d74ff]/20 flex-shrink-0"></div>
      ...
      <section id="features" class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-16 sm:py-24">
        <div class="text-center mb-12">
          <h2 class="text-3xl sm:text-5xl font-black tracking-tight mb-4 text-slate-900 dark:text-white">Built for <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#6d74ff] to-blue-400">Scale</span></h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div *ngFor="let f of features" class="bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08] shadow-md dark:shadow-none backdrop-blur-md rounded-2xl p-6 sm:p-8 hover:border-[#6d74ff]/30 transition-all hover:scale-[1.02] group">
            <div class="w-12 h-12 bg-gradient-to-br from-[#6d74ff]/10 dark:from-[#6d74ff]/20 to-blue-500/10 dark:to-blue-500/20 rounded-xl flex items-center justify-center mb-5 text-xl">{{f.icon}}</div>
      ...
      <section class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-16 sm:py-24">
        <div class="bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08] shadow-xl dark:shadow-none backdrop-blur-md rounded-3xl p-8 sm:p-16 text-center relative overflow-hidden">
          ...
          <h2 class="text-3xl sm:text-5xl font-black tracking-tight mb-4 text-slate-900 dark:text-white">Ready to <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#6d74ff] to-blue-400">Optimize?</span></h2>
          <p class="text-slate-600 dark:text-slate-300 max-w-lg mx-auto mb-8">Join thousands of businesses managing inventory with clarity. Free forever for small teams.</p>
      ...
      <!-- Footer -->
      <footer class="relative z-10 border-t border-slate-200 dark:border-white/[0.06] bg-slate-50 dark:bg-transparent">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 py-10">
          <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-2">
              ...
              <span class="text-sm font-bold text-slate-900 dark:text-white">Inven<span class="text-[#6d74ff]">tory</span></span>
            </div>
            <p class="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-widest">© 2026 Inventory. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
