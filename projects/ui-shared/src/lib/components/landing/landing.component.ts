...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-slate-50 dark:bg-dark-base overflow-hidden relative">

      <!-- Nav -->
      <nav class="relative z-20 border-b border-slate-200 dark:border-white/[0.06] bg-white/80 dark:bg-dark-base/80 backdrop-blur-xl sticky top-0">
        <div class="flex justify-between items-center px-6 lg:px-8 py-4 max-w-7xl mx-auto">
          <div class="flex items-center gap-2.5">
            <div class="w-10 h-10 bg-gradient-to-br from-primary to-blue-500 rounded-xl flex items-center justify-center">
              <span class="text-white font-black text-lg">I</span>
            </div>
            <span class="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Inven<span class="text-primary">tory</span></span>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <a routerLink="/user/register" class="px-5 py-2.5 bg-primary hover:bg-primary/90 text-white rounded-xl transition-all font-bold text-sm">Get Started</a>
      ...
      <main class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-16 sm:pt-24 pb-20 sm:pb-32 flex flex-col items-center text-center">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] backdrop-blur-md rounded-full mb-8 text-xs font-bold text-primary uppercase tracking-widest shadow-sm dark:shadow-none">
        ...
        <h1 class="text-4xl sm:text-6xl lg:text-8xl font-black tracking-tighter mb-6 leading-[1.05] text-slate-900 dark:text-white">
          ...
          <span class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-400">Management.</span>
        </h1>
        ...
        <div class="w-full max-w-5xl bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] backdrop-blur-md rounded-2xl sm:rounded-3xl p-2 sm:p-4 shadow-xl dark:shadow-2xl relative">
          <div class="absolute inset-0 bg-gradient-to-t from-white/90 dark:from-dark-base/90 via-transparent to-transparent z-10 rounded-2xl pointer-events-none"></div>
          <div class="bg-slate-50 dark:bg-dark-elevated rounded-xl overflow-hidden border border-slate-200 dark:border-transparent">
            <div class="flex items-center gap-2 px-4 py-3 border-b border-slate-200 dark:border-white/[0.06]">
              ...
              <div class="flex-1 flex justify-center"><div class="px-4 py-1 bg-white dark:bg-dark-base/50 border border-slate-200 dark:border-transparent rounded-md text-[10px] text-slate-500 font-mono shadow-sm dark:shadow-none">inventory.app/dashboard</div></div>
            </div>
      ...
      <section id="features" class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-16 sm:py-24">
        <div class="text-center mb-12">
          <h2 class="text-3xl sm:text-5xl font-black tracking-tight mb-4 text-slate-900 dark:text-white">Built for <span class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-400">Scale</span></h2>
      ...
      <section class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-16 sm:py-24">
        <div class="bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08] shadow-xl dark:shadow-none backdrop-blur-md rounded-3xl p-8 sm:p-16 text-center relative overflow-hidden">
          <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[60%] h-[2px] bg-gradient-to-r from-transparent via-primary to-transparent"></div>
          <h2 class="text-3xl sm:text-5xl font-black tracking-tight mb-4 text-slate-900 dark:text-white">Ready to <span class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-400">Optimize?</span></h2>
          ...
          <a routerLink="/user/register" class="inline-block px-10 py-4 bg-primary text-white rounded-xl font-bold text-lg hover:bg-primary-hover transition-colors">Start Free Today</a>
        </div>
      </section>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 py-10">
          <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-2">
              <div class="w-7 h-7 bg-gradient-to-br from-primary to-blue-500 rounded-lg flex items-center justify-center"><span class="text-white font-black text-xs">I</span></div>
              <span class="text-sm font-bold text-slate-900 dark:text-white">Inven<span class="text-primary">tory</span></span>
            </div>
