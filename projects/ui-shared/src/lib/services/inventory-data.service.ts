...
export class InventoryDataService {
  ...
  private generateProducts(): Product[] {
    return [
      ...
      {
        id: 18,
        name: 'Relay Module 8-CH',
        category: 'Electronics',
        price: 45,
        stock: 450,
        description: '8-channel relay board for low-voltage signal control.',
        supplierId: 'SUP-001',
        warehouseId: 'WH-001',
      },
      {
        ...
        price: 125,
        stock: 200,
        description: 'Heavy-duty steel roller for industrial conveyor systems.',
        supplierId: 'SUP-005',
        warehouseId: 'WH-001',
      },
      {
      ...
      },
      {
        ...
        price: 890,
        stock: 12,
        description: 'Professional TIG welding torch with ergonomic grip.',
        supplierId: 'SUP-002',
        warehouseId: 'WH-002',
      },
    ];
  ...
  private generateOffers(): Offer[] {
    return [
      {
        id: 'OFFER-1',
        title: 'Summer Industrial Expo',
        description: '20% off all Electronics and Sensors this week only.',
        discount: 20,
        category: 'Electronics',
    ...
    return [
      {
        ...
        reference: 'PAY-INV-2341',
        recipient: 'TechNexus Industries',
      },
    ];
  }
}
